...
})({"5QQZA":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "ae2f7cd31579bde7";
"use strict";
...
},{}],"hKk3R":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
const game_1 = require("5e400b69b8477c99");
window.onload = ()=>{
    const game = new game_1.SpaceInvadersGame("gameCanvas");
    game.start();
};

},{"5e400b69b8477c99":"fu873"}],"fu873":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.SpaceInvadersGame = void 0;
const alien_1 = require("a31d1dc6c8d0045b");
const player_1 = require("39131e3003ccbae0");
const collisionManager_1 = require("182c50e78ba476ab");
const fpsmanager_1 = require("29c1edf4aa422a57");
/**
 ...
 */ class SpaceInvadersGame {
     ...
     */ update() {
        ...
        for (const bullet of allBullets)bullet.update(this.ctx);
        // Players
        ...
        for (const alien of this.aliens)alien.update(this.ctx);
     ...
     */ draw() {
        ...
        for (const player of this.players){
            ...
            for (const bullet of player.bullets)bullet.draw(this.ctx);
        }
        // Draw aliens
        for (const alien of this.aliens)alien.draw(this.ctx);
        // Draw FPS
    ...
    /**
       ...
       */ collisions(allBullets) {
        for (const alien of this.aliens){
            for (const bullet of allBullets)// Check each alien against each bullet
            // TODO: Surely real gamedevs have tricks to reduce computation here
            if (this.collisionManager.checkCollision(alien, bullet)) alien.destroy = true;
        }
    }
    /**
     ...
     */ initAliens() {
        for(let i = 0; i < 5; i++)for(let j = 0; j < 10; j++){
            const x = 50 + j * 100;
            const y = 30 + i * 60;
            this.aliens.push(new alien_1.Alien({
                x,
                y
            }, 0.1));
        }
...
},{"a31d1dc6c8d0045b":"bTx9q","39131e3003ccbae0":"96zdY","182c50e78ba476ab":"hyvcO","29c1edf4aa422a57":"1yoYb"}],"bTx9q":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.Alien = void 0;
const base_1 = require("a18f0455892b7fc4");
const color_1 = require("d87439124f7d9cd5");
class Alien extends base_1.Entity {
    ...
    update(ctx) {
        if (this.moveDown) {
            ...
            this.moveDown = false;
        } else this.position.x += this.speed * Number(this.xVelocity);
        // Check if at the edge of the canvas and need to move down 
        if (this.position.x <= 0 && this.xVelocity < 0 || this.position.x >= ctx.canvas.width && this.xVelocity > 0) this.moveDown = true;
    }
    draw(ctx) {
        ctx.beginPath();
        ctx.arc(this.position.x, this.position.y, 10, 0, 2 * Math.PI);
        ctx.fillStyle = color_1.Colors.SECONDARY;
        ctx.fill();
    }
}
exports.Alien = Alien;

},{"a18f0455892b7fc4":"1SkUX","d87439124f7d9cd5":"cShYF"}],"1SkUX":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{}],"cShYF":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
exports.Colors = {
    BACKGROUND: "#221569",
    PRIMARY: "#4a2eca",
    PRIMARY_ACCENT: "#a83cf0",
    SECONDARY: "#db3cf0",
    SECONDARY_ACCENT: "#f465ee",
    UI: "#b5e6ff",
    UI_ACCENT: "#84d5fe",
    EFFECT: "#4ec0e8",
    HIGHLIGHT: "#4ea3dc",
...
},{}],"96zdY":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.Player = void 0;
const base_1 = require("536a79f40a97dac3");
const bullet_1 = require("6c5ed57e1eb72499");
const color_1 = require("7d5a12d4d661870f");
class Player extends base_1.Entity {
    ...
    update(ctx) {
        if (this.keyPresses["w"]) this.position.y -= this.speed;
        if (this.keyPresses["s"]) this.position.y += this.speed;
        if (this.keyPresses["a"]) this.position.x -= this.speed;
        if (this.keyPresses["d"]) this.position.x += this.speed;
        if (this.bullets.length < 100 && this.cycles % this.fireRate == 0) this.fire();
...
},{"536a79f40a97dac3":"1SkUX","6c5ed57e1eb72499":"ct4RY","7d5a12d4d661870f":"cShYF"}],"ct4RY":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.Bullet = void 0;
const base_1 = require("1fb0bcad199a79bb");
const color_1 = require("41dada8e20dcf210");
class Bullet extends base_1.Entity {
    ...
    update(_ctx) {
        ...
        if (this.position.y < 0) this.destroy = true;
    }
}
exports.Bullet = Bullet;

},{"1fb0bcad199a79bb":"1SkUX","41dada8e20dcf210":"cShYF"}],"hyvcO":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{}],"1yoYb":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
...
},{}]},["5QQZA","hKk3R"], "hKk3R", "parcelRequire94c2")

//# sourceMappingURL=index.1579bde7.js.map
